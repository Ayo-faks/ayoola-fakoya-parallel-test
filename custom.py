...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 custom.py inference_parallel  --weights=/path/to/weights/file.h5 --video=<webcam, URL or path to file>
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train', 'splash', 'splash_movie or 'inference_parallel'")
    ...
    elif args.command == "inference_parallel":
        detect_classic_in_video(model, video_path=args.video)
    else:
        print("'{}' is not recognized. "
              "Use 'train', 'splash', 'splash_movie' or 'inference_parallel'".format(args.command))
